...
if ! git diff --quiet trade-audit.json README.md performance-chart.svg 2>/dev/null; then
    # Commit locally (this always succeeds)
    git add trade-audit.json README.md performance-chart.svg 2>&1 | logger -t tiverton-audit
